...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory(
        ...
        factory.setConcurrency(2);  // 2 concurrent consumers (notification is lower priority)
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                (record, exception) -> {
                    ...
                    kafkaTemplate.send("notification-service.dlq", record.key().toString(), record.value());
                },
    ...
    public KafkaTemplate<String, Object> kafkaTemplate() {
        return new KafkaTemplate<>(new DefaultKafkaConsumerFactory<>(new HashMap<>()));
    }
}
